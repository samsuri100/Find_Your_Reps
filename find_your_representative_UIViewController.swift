...
class Find_My_Representative_UIViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let category_patterns = [("ocd-division/country:us/state:"+state+"/county:"+county): "cty",
